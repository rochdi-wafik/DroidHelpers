 ...
 *   before initialize the class by using: SimpleDB.enableEncryption=false
 *   (In application class or any start point)
 */
public class SimpleDB {
    private static final String TAG = "__SimpleDB";
    ...
    public <T> void saveObject(T object, String key){
        Logger.d(TAG + " saveObject(): "+object.getClass().getSimpleName());
        ...
        sharedPreferences.edit().putString(OBJ_KEY, jsonObj).apply();
    }
    ...
    public <T> void saveListObject(List<T> listObject, String key){
        ...
        Logger.d(TAG + " saveListObject(): "+listObject.get(0).getClass().getSimpleName());
     ...
     * @return object:
     */
    public <T> @Nullable T getObject(Class<T> classType, String key){
        Logger.d(TAG + " getObject(): "+classType.getSimpleName());
    ...
    public <T> @Nullable List<T> getListObject(Class<T> classType, String key){
        Logger.d(TAG + " getListObject(): "+classType.getSimpleName());
        if(sharedPreferences==null) return null;
    ...
    public void removeObject(String key){
        ...
        try{
            sharedPreferences.edit().remove(OBJ_KEY).apply();
