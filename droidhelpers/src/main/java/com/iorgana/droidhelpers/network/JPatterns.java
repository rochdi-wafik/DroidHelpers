...
public class JPatterns {
    ...
    public static final String PROTOCOL = "(?i:[a-z]+)://";
     ...
     */
    public static final String STRICT_TLD = "(?:" + IANA_TOP_LEVEL_DOMAINS + "|" + PUNYCODE_TLD + ")";
    /**
     ...
     * -----------------------------------------------------------------------------
     */
    public static final String DOMAIN_WITH_PORT_STR = "(" + HOST_NAME + "(?:" + PORT_NUMBER + ")?" + "|" + IP_ADDRESS_STRING + "(?:" + PORT_NUMBER + ")?" + ")" ;
    public static final Pattern DOMAIN_WITH_PORT = Pattern.compile(DOMAIN_WITH_PORT_STR);
    /**
     * IP Address: support port number
     */
    public static final String IP_WITH_PORT_STR =
            "((25[0-5]|2[0-4][0-9]|[0-1][0-9]{2}|[1-9][0-9]|[1-9])\\.(25[0-5]|2[0-4]"
                    + "[0-9]|[0-1][0-9]{2}|[1-9][0-9]|[1-9]|0)\\.(25[0-5]|2[0-4][0-9]|[0-1]"
                    + "[0-9]{2}|[1-9][0-9]|[1-9]|0)\\.(25[0-5]|2[0-4][0-9]|[0-1][0-9]{2}"
                    + "|[1-9][0-9]|[0-9])"
                    + "(?:" + PORT_NUMBER + ")?)";
    public static final Pattern IP_WITH_PORT = Pattern.compile(IP_WITH_PORT_STR);
}
